...
1. Which Apify actor(s) to use for company discovery, and their confirmed pricing model/input schema (§8.1) — cannot be finalized without logging into the Apify Console.
